...
pushd "%ANDROID_DIR%"
call "%GRADLE%" :app:assembleDebug --no-daemon -PA51_ENABLE_OPENXR=true -PA51_ANDROID_CONFIGURATION=OptDebug -PA51_DIRECT_RENDER=true
...
if "%BUILD_EXIT%"=="0" (
    echo.
    echo Quest 3 direct color/depth OptDebug APK:
