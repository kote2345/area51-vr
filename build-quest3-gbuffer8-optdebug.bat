...
pushd "%ANDROID_DIR%"
call "%GRADLE%" :app:assembleDebug --no-daemon -PA51_ENABLE_OPENXR=true -PA51_ANDROID_CONFIGURATION=OptDebug -PA51_GBUFFER_LOW_BW=true
...
if "%BUILD_EXIT%"=="0" (
    echo.
    echo Quest 3 low-bandwidth G-buffer OptDebug APK:
